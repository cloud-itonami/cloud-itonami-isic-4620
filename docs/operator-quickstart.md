# Operator Quickstart — Wholesale of agricultural raw materials and live animals

Shortest path from clone to a verified local dry-run for **ISIC 4620** (`cloud-itonami-isic-4620`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4620.git
cd cloud-itonami-isic-4620
```
...
- Blueprint governor key: `agri-trading-governor`
- Likely source path: `agritrade.governor.cljc`
